...
// moduleKey (opcjonalnie): gdy podany, tytuł bierze DYNAMICZNĄ nazwę modułu z bazy
// (app_modules.label) — dzięki temu zmiana nazwy modułu w Ustawieniach jest widoczna
