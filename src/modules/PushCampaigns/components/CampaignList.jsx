...
import {
  Bell, Send, Clock, FileText, MoreVertical, Edit, Copy, Trash2,
  CheckCircle, XCircle, AlertCircle, Users, Calendar, TrendingUp,
  Eye, MousePointer, ArrowRight, Plus, X
} from 'lucide-react';
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtered.map(c => {
            ...
            const openRate = total > 0 ? Math.round((c.opened_count || 0) / total * 100) : 0;
            const actionRate = total > 0 ? Math.round((c.action_clicked_count || 0) / total * 100) : 0;
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 truncate mt-0.5">{c.title}</p>
                    </div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-400 line-clamp-2 mb-3">{c.body}</p>
