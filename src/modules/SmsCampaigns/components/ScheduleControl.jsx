...
const MODES = [
  { id: 'now', label: 'Wyślij teraz', icon: Send, description: 'SMS idą natychmiast po zapisie.' },
    ...
    <div className="space-y-4">
      ...
      <details className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
        ...
        <div className="mt-3 space-y-3">
          ...
          <div>
            <label className="text-xs text-gray-500 mb-1 block">Max SMS-ów dziennie do jednego odbiorcy</label>
            <input
              type="number"
              min={1}
              max={20}
